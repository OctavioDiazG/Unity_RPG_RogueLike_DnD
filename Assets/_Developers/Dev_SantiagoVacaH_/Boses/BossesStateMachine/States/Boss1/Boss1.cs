...
public class Boss1 : Entity
{
    ...
    public B1_SpecialState specialState { get; private set; }
    ...
    [SerializeField] private B_ChaseState b_chaseStateData;
    ...
    public override void Start()
    {
        ...
        chaseState = new B1_ChaseState(this, stateMachine, "chase", chaseStateData, GameObject.Find("Player"), this, b_chaseStateData);
        attackState = new B1_AttackState(this, stateMachine, "attack", attackStateData, player.GetComponent<PlayerDumy>(), this);
        specialState = new B1_SpecialState(this, stateMachine, "special", attackStateData, player.GetComponent<PlayerDumy>(), this, bEntity);
